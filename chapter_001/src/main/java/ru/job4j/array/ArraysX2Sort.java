 ...
 * я знал что вы меня об этом спросите т.к. я ещё ночью об  этом задумался и пол дня потрати на написание условий
 * выручило sout чтобы отслеживать что происходит)) когда был задан вопрос :
 * что будет если массивы разной длинны- ответ уже почти был готов) я только доумывал что делать с последним значением,
